    ...
    for config in configs:
        ...
        cards.append(
            AnalyticsSummaryCard(
                ...
                metric_type=metric_type,
                unit=unit,
                usage_today=round(usage_today, 4) if usage_today else None,
                usage_week=round(usage_week, 4) if usage_week else None,
                avg_per_day=round(usage_week / 7, 4) if usage_week else None,
